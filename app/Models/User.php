 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Edl> $edls
 * @property-read int|null $edls_count
 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|User whereMicrosoftId($value)
